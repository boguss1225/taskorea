...
<div id="bo_gall">
    <div class="container">
        ...
        <ul id="gall_ul">
            ...
            ?>
            <li class="col-lg-4 col-md-4 col-sm-6 col-xs-12 gall_li <?php if ($wr_id == $list[$i]['wr_id']) { ?>gall_now<?php } ?>">
                <div class="gall_text_href panel-heading">
                    <?php
                ...
                <div class="gall_href">
                   ...
                   <div class="gall_block"><a href="<?php echo $list[$i]['href'] ?>"><img src="<?php echo G5_THEME_URL; ?>/img/mouse_over.png" alt="자세히보기" /></a></div>
                </div>
                <div class="gall_detail panel-body">
                    <?php echo get_text(cut_str(strip_tags($list[$i]['wr_content']), 50), 1); ?>
                </div>
            <?php } ?>
